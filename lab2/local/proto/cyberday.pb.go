...
const file_proto_cyberday_proto_rawDesc = "" +
	...
	"\atermino\x18\x03 \x01(\bR\atermino\"D\n" +
	...
	"\x06offers\x18\x01 \x03(\v2\x0f.cyberday.OfferR\x06offers2c\n" +
	...
	"\x0fGetOfferHistory\x12\x19.cyberday.RecoveryRequest\x1a\x1a.cyberday.RecoveryResponse2@\n" +
	"\x06Broker\x126\n" +
...
var file_proto_cyberday_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_cyberday_proto_goTypes = []any{
	...
	(*BrokerResponse)(nil),          // 6: cyberday.BrokerResponse
	(*StoreOfferResponse)(nil),      // 7: cyberday.StoreOfferResponse
	(*ConsumerResponse)(nil),        // 8: cyberday.ConsumerResponse
	(*RecoveryRequest)(nil),         // 9: cyberday.RecoveryRequest
	(*RecoveryResponse)(nil),        // 10: cyberday.RecoveryResponse
}
var file_proto_cyberday_proto_depIdxs = []int32{
	...
	9,  // 5: cyberday.DBNode.GetOfferHistory:input_type -> cyberday.RecoveryRequest
	0,  // 6: cyberday.Broker.PostOffer:input_type -> cyberday.Offer
	...
	7,  // 11: cyberday.DBNode.StoreOffer:output_type -> cyberday.StoreOfferResponse
	10, // 12: cyberday.DBNode.GetOfferHistory:output_type -> cyberday.RecoveryResponse
	6,  // 13: cyberday.Broker.PostOffer:output_type -> cyberday.BrokerResponse
	8,  // 14: cyberday.Consumer.ReceiveOffer:output_type -> cyberday.ConsumerResponse
