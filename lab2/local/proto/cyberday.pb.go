...
// Respuesta del Broker al Productor después de SendOffer (reemplaza OfferResponse)
...
const file_proto_cyberday_proto_rawDesc = "" +
	"\n" +
	"\x14proto/cyberday.proto\x12\bcyberday\"\xba\x01\n" +
	"\x05Offer\x12\x1b\n" +
	...
	"\x05fecha\x18\a \x01(\tR\x05fecha\"m\n" +
	...
	"\x06DBNode\x12;\n" +
	"\n" +
	"StoreOffer\x12\x0f.cyberday.Offer\x1a\x1c.cyberday.StoreOfferResponseB\rZ\v./;cyberdayb\x06proto3"
...
var file_proto_cyberday_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_cyberday_proto_goTypes = []any{
	...
	(*StoreOfferResponse)(nil),      // 4: cyberday.StoreOfferResponse
}
var file_proto_cyberday_proto_depIdxs = []int32{
	...
	2, // 3: cyberday.EntityManagement.RegisterEntity:output_type -> cyberday.RegistrationResponse
	3, // 4: cyberday.OfferSubmission.SendOffer:output_type -> cyberday.OfferSubmissionResponse
	4, // 5: cyberday.DBNode.StoreOffer:output_type -> cyberday.StoreOfferResponse
