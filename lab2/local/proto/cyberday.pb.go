...
// Respuesta del Broker al Productor despues de SendOffer
...
// Response que el Nodo DB envia al Broker despues de intentar guardar la oferta.
...
// FASE 4: Respuesta que el Consumidor envia al Broker despues de recibir la oferta.
...
// Mensaje para solicitar historial de ofertas a un peer DB Node
...
// Respuesta que contiene el historial de ofertas
type RecoveryResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Offers        []*Offer               `protobuf:"bytes,1,rep,name=offers,proto3" json:"offers,omitempty"` // Devuelve todas las ofertas
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Request para simular un fallo en el Nodo DB
type FailureRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	DurationSeconds int32                  `protobuf:"varint,1,opt,name=duration_seconds,json=durationSeconds,proto3" json:"duration_seconds,omitempty"` // Duracion del fallo
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *FailureRequest) GetDurationSeconds() int32 {
	if x != nil {
...
// Response del Nodo DB al Broker sobre el control de fallo
...
func (x *FailureResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *FailureResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_proto_cyberday_proto_rawDesc = "" +
	...
	"\x0eFailureRequest\x12)\n" +
	"\x10duration_seconds\x18\x01 \x01(\x05R\x0fdurationSeconds\"E\n" +
	"\x0fFailureResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	...
	"\bConsumer\x12;\n" +
	"\fReceiveOffer\x12\x0f.cyberday.Offer\x1a\x1a.cyberday.ConsumerResponse2S\n" +
	"\tDBControl\x12F\n" +
	"\x0fSimulateFailure\x12\x18.cyberday.FailureRequest\x1a\x19.cyberday.FailureResponseB\rZ\v./;cyberdayb\x06proto3"
...
var file_proto_cyberday_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_cyberday_proto_goTypes = []any{
	...
	(*FailureRequest)(nil),          // 10: cyberday.FailureRequest
	(*FailureResponse)(nil),         // 11: cyberday.FailureResponse
}
var file_proto_cyberday_proto_depIdxs = []int32{
	0,  // 0: cyberday.RecoveryResponse.offers:type_name -> cyberday.Offer
	1,  // 1: cyberday.EntityManagement.RegisterEntity:input_type -> cyberday.RegistrationRequest
	3,  // 2: cyberday.ConfirmarInicio.Confirmacion:input_type -> cyberday.ConfirmRequest
	0,  // 3: cyberday.OfferSubmission.SendOffer:input_type -> cyberday.Offer
	0,  // 4: cyberday.DBNode.StoreOffer:input_type -> cyberday.Offer
	8,  // 5: cyberday.DBNode.GetOfferHistory:input_type -> cyberday.RecoveryRequest
	0,  // 6: cyberday.Consumer.ReceiveOffer:input_type -> cyberday.Offer
	10, // 7: cyberday.DBControl.SimulateFailure:input_type -> cyberday.FailureRequest
	2,  // 8: cyberday.EntityManagement.RegisterEntity:output_type -> cyberday.RegistrationResponse
	4,  // 9: cyberday.ConfirmarInicio.Confirmacion:output_type -> cyberday.ConfirmResponse
	5,  // 10: cyberday.OfferSubmission.SendOffer:output_type -> cyberday.OfferSubmissionResponse
	6,  // 11: cyberday.DBNode.StoreOffer:output_type -> cyberday.StoreOfferResponse
	9,  // 12: cyberday.DBNode.GetOfferHistory:output_type -> cyberday.RecoveryResponse
	7,  // 13: cyberday.Consumer.ReceiveOffer:output_type -> cyberday.ConsumerResponse
	11, // 14: cyberday.DBControl.SimulateFailure:output_type -> cyberday.FailureResponse
