...
recibir el número de estrellas en tiempo real las cuales son notificadas por Lester. En caso de 3 estrellas se activa su habilidad en donde Chop recolecta botin extra y en caso de 5 estrellas la mision fracasa. En caso de éxito retorna el botín base, el botín extra y las estrellas al finalizar y en caso de fracaso se incluye también el motivo.
***
*/
...
***
Consume mensajes desde la cola de RabbitMQ "estrellas_Franklin" y actualiza
...
***
Valida el pago entregado por Michael. Comprueba que lo recibido sea el 25% del total. Retorna si el pago es correcto y un mensaje a ser incluido en el reporte final.
***
*/
